...
When looking at the albums online, I envisioned a selection option for the user to choose a desired album (but also made it run 
	for all albums if desired).

Once I saw that the source data was in JSON, all that was needed was a JSON package that could handle it (I went with Newtonsoft).
...
I initially had it laid out in a "Photo ID: " + id + ", Photo Title: " + title design but decided it was best to stick
	to formatting on example PDF.
